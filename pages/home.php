                     ...
                     <div class="row text-center">
                         ...
                         <div class="col-lg-4 col-md-6">
                             ...
                             <div class="view overlay rounded z-depth-1 zoom">
                                 ...
                                 <a id="dwn" href="https://github.com/ingeniousambivert/weather-fetching" target="_blank">
                     ...
                     <div class="col-lg-6 col-md-12">
                         ...
                         <div class="single-news mb-lg-0 mb-4">
                             ...
                             <div class="view overlay rounded z-depth-1-half mb-4">
                                 <img class="img-fluid" src="https://images.unsplash.com/photo-1533895328642-8035bacd565a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80" alt="Sample image">
                                 <a>
                                     <div class="mask rgba-white-slight"></div>
                                 </a>
                             </div>
                             ...
                             <div class="row">
                                 ...
                                 <div class="col-md-3">
                                     ...
                                     <div class="view overlay rounded z-depth-1 mb-4">
                                         <img class="img-fluid" src="https://techcrunch.com/wp-content/uploads/2018/12/bird-box.jpg" alt="Sample image">
                                         <a>
                                             <div class="mask rgba-white-slight"></div>
                                         </a>
                                     </div>
                                     ...
                                     <div class="d-flex justify-content-between">
                                         <div class="col-11 text-truncate pl-0 mb-3">
                                             <a class="dark-grey-text">Sandra Bullock’s star power can still sell a movie, apparently. Though reviews for the Netflix horror film “Bird Box” have been lukewarm — the movie has a respectable, but not outstanding, score of 65 percent on Rotten Tomatoes — it has still managed to break records for the streaming service, Netflix said this afternoon.
                                                 ...
                                                 The company announced in a tweet that more than 45 million Netflix accounts have now streamed “Bird Box,” which set a new record for the best-ever first week for a Netflix film.<a class="grey-text" href="https://techcrunch.com/2018/12/28/bird-box-breaks-a-netflix-record-with-45m-people-watching-in-its-first-week/" target="_blank">Read More...</a></a>
                                         </div>
                         ...
                         <div class="single-news mb-4">
                             ...
                             <div class="row">
                                 ...
                                 <div class="col-md-3">
                                     ...
                                     <!--Image-->
                                     <div class="view overlay rounded z-depth-1 mb-4">
                                         <img class="img-fluid" src="https://techcrunch.com/wp-content/uploads/2018/12/vsmp.jpg?w=1390&crop=1" alt="Sample image">
                                         <a>
                                             <div class="mask rgba-white-slight"></div>
                                         </a>
                                     </div>
                                     ...
                                     <div class="d-flex justify-content-between">
                                         <div class="col-11 text-truncate pl-0 mb-3">
                                             <a class="dark-grey-text">It seems someone took Every Frame a Painting literally: The Very Slow Movie Player is a device that turns cinema into wallpaper, advancing the image by a single second every hour. The result is an interesting household object that makes something new of even the most familiar film.
                                                 ...
                                                 The idea occurred to designer and engineer Bryan Boyer during one of those times we all have where we are sitting at home thinking of ways to celebrate slowness.<a class="grey-text" href="https://techcrunch.com/2018/12/28/the-very-slow-movie-player-shows-a-film-over-an-entire-year/" target="_blank">Read More...</a></a>
                                         </div>
                                         <a><i class="fa fa-angle-double-right"></i></a>
                                     </div>
                         ...
                         <div class="single-news mb-4">
                             ...
                             <div class="row">
                                 ...
                                 <div class="col-md-3">
                                     ...
                                     <!--Image-->
                                     <div class="view overlay rounded z-depth-1 mb-4">
                                         <img class="img-fluid" src="https://i.ytimg.com/vi/jloL2NiqWUE/maxresdefault.jpg" alt="Sample image">
                                         <a>
                                             <div class="mask rgba-white-slight"></div>
                                         </a>
                                     </div>
                                     ...
                                     <div class="d-flex justify-content-between">
                                         <div class="col-11 text-truncate pl-0 mb-3">
                                             <a class="dark-grey-text">
                                                 ...
                                                 Founder Jay “Saurik “ Freeman revealed the news via a Reddit post this week recommending users remove PayPal accounts from their profile.<a class="grey-text" href="https://techcrunch.com/2018/12/15/cydia-shuts-down-purchasing-mechanism-for-its-jailbreak-app-store/" target="_blank">Read More...</a></a>
                                         </div>
                                         <a><i class="fa fa-angle-double-right"></i></a>
                                     </div>
                             ...
                             <div class="row">
                                 ...
                                 <div class="col-md-3">
                                     ...
                                     <div class="view overlay rounded z-depth-1 mb-md-0 mb-4">
                                         <img class="img-fluid" src="https://techcrunch.com/wp-content/uploads/2018/12/krisp_head.png?w=1390&crop=1" alt="Sample image">
                                         <a>
                                             <div class="mask rgba-white-slight"></div>
                                         </a>
                                     </div>
                                     ...
                                     <div class="d-flex justify-content-between">
                                         <div class="col-11 text-truncate pl-0 mb-lg-3">
                                             <a class="dark-grey-text">
                                                 ...
                                                 <a class="grey-text" href="https://techcrunch.com/2018/12/10/krisp-reduces-noise-on-calls-using-machine-learning-and-its-coming-to-windows-soon/" target="_blank">Read More...</a></a>
                                         </div>
                                         <a><i class="fa fa-angle-double-right"></i></a>
                                     </div>
